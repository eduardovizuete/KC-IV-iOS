...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        obtainReferenceToDetailViewControllerFromSplitViewControllerForUSeIDontKnowWhen()
    }
    
    func obtainReferenceToDetailViewControllerFromSplitViewControllerForUSeIDontKnowWhen() {
